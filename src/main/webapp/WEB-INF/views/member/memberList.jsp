...
<head>
  ...
  <script>
    ...
    function delCheck(idx) {
    	...
    	$.ajax({
    		type : "post",
    		url : "${ctp}/member/memberListDeletOk",
    		data : {idx : idx},
    		success:function() {
					alert("회원이 삭제되었습니다");
					location.reload();
