...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="http://192.168.50.71:9090/javawspring" class="w3-bar-item w3-button w3-padding-large">HOME</a>
    ...
    <c:if test="${sLevel <= 4}">
	    ...
	    <div class="w3-dropdown-hover w3-hide-small">
	      ...
	      <div class="w3-dropdown-content w3-bar-block w3-card-4">
	        <a href="${ctp}/study/password/sha256" class="w3-bar-item w3-button">암호화연습(SHA256)</a>
